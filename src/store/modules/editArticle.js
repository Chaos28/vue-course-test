...
export const mutationTypes = {
  ...
  getArticleStart: '[update Article] get Article start',
  getArticleSuccess: '[update Article] get Article success',
  getArticleFailure: '[update Article] get Article failure',
};

export const actionTypes = {
  updateArticle: '[update Article] update Article',
  getArticle: '[update Article] get Article',
};
